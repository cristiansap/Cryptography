...
Some cryptography solutions (e.g., RSA Boneh-Durfee attack) are taken or adapted from public repositories for **educational purposes**:

- RSA Wang/Boneh-Durfee attack: https://github.com/maximmasiutin/rsa-boneh-durfee/blob/master/boneh_durfee.sage
- MD4 collision: https://github.com/HMY626/MD4-Collision/blob/master/MD4Collision.py
